...
"""%s
 ...
 - author      : SMR MILON 
 - facebook    : facebook.com/SMR_White_Devil_MILON
 - fanspage    : facebook.com/100022086172556
 - whatsap     : +8801307070707
 - github      : github.com/SMR_White_Devil_MILON
 - script name : Mr.Joker
 - version     : 1.9
 
 - author      : SMR_White_Devil_MILON
 - facebook    : facebook.com/SMR_White_Devil_MILON
 - fanspage    : facebook.com/100022086172556
 - whatsap     : +8801307070707
 - github      : github.com/SMR_White_Devil_MILON
...
def masuk():
    ...
    if mbo in(""):
    	...
    	try:
        	...
        	print("%s\033[33m[\x1b[1;92m✓\033[33m] \x1b[0;34mCookie invalid "%(M));masuk()
    elif mbo in ('2', '02'):
...
def menu():
    ...
    try:
        ...
        print ("%s\033[33m[\x1b[1;92m✓\033[33m] \x1b[38;5;208mChang CuterS "%(M));jeda(2);os.system('rm -rf token.txt');masuk()
    try:
        ...
        print("%s\033[33m[\x1b[1;92m✓\033[33m] \x1b[0;34mChang CuterS \x1b[1;92m✓ "%(M));jeda(2);os.system('rm -rf data/token.txt && rm -rf data/cookies');masuk()
    except requests.exceptions.ConnectionError:
        exit("%s [!] Kesalahan koneksi "%(M))
    banner()
    kotak()
#    banner()
    print (' %s[∆] Auhtor    : SMR MILON'%(P))
    print (' [∆] gh auhtor : https://github.com/SMRmilon01')
    print (' [∆] gh auhtor : https://github.com/SMRmilon01')
    print (jembut)
...
#    print (' [%s09%s] Info script'%(P,P))
  #  print (' [%s10%s] Crack Instagram [%sNew%s]'%(P,P,H,P))
    ...
    if _romi_x_mbokey_ == '':
        print("%s\033[33m[\x1b[1;92m✓\033[33m] \x1b[0;34mIsi Yang Benar Kentod "%(M));jeda(2);menu()
        ...
        with requests.Session() as ses:
            try:
                ...
                if "users" in json.loads(otw.content):
                    ...
                    print('\n%s[%s×%s] \x1b[38;5;208mChang CuterS'%(N,M,N));time.sleep(2);os.system('rm -rf ig.txt');masuk_ig()
            except ValueError:
                print('\n%s[%s×%s] \x1b[38;5;208mChang CuterS'%(N,M,N));time.sleep(2);os.system('rm -rf ig.txt');masuk_ig()
def masuk_ig():
    global cookie
